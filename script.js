    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "STXR-FLY uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c48f623d-a2e7-4739-9721-54a1323ea865',
                    name: data.name || '',
                    email: data.email || '',
